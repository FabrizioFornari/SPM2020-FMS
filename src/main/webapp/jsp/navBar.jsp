...
<style type="text/css">
body {
	background: linear-gradient(rgba(176, 176, 176, 0.5),
		rgba(255, 255, 255, .5)),
		url(${pageContext.request.contextPath}/resources/images/parking.jpg);
}
</style>
</head>
<body>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<c:if test="${user.getUserType() == 'Policeman' }">
					<li class="nav-item"><a class="nav-link"
						href="reservationsToCheck"><span class="fas fa-id-badge"></span>
							Reservations</a></li>
				</c:if>
