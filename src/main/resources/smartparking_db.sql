CREATE DATABASE  IF NOT EXISTS `smartparking_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `smartparking_db`;
...
CREATE TABLE `parkingspace` (
  ...
  `Spots_capacity` int(11) NOT NULL,
  `Covered_spots` int(11) NOT NULL,
  `Handicap_spots` int(11) NOT NULL,
  `IsGuarded` tinyint(4) NOT NULL,
...
-- Dump completed on 2021-01-07 15:59:50